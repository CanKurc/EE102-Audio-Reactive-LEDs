...
#ifndef _master_wrapper_xlconcat_1_0_core_h_
#define _master_wrapper_xlconcat_1_0_core_h_
...
class master_wrapper_xlconcat_1_0_core : public sc_module 
{
    public: 
       master_wrapper_xlconcat_1_0_core (sc_core::sc_module_name nm, const xsc::common_cpp::properties& props)
            : sc_module(nm)
              , In0    ( "In0" )
              , In1    ( "In1" )
              , dout   ( "dout" )
    {
        SC_HAS_PROCESS(master_wrapper_xlconcat_1_0_core);
    ...
    virtual ~master_wrapper_xlconcat_1_0_core() = default;
